<template>
  <div id="icons">
    ...
    <section id="form-control">
      <h2 class="page-header">表单控制图标</h2>
      <div class="row fontawesome-icon-list">
        <div class="fa-icon-item">
          <i class="fa fa-check-square"></i>
          check-square
    ...
    <section id="text-editor">
      <h2 class="page-header">文字编辑图标</h2>
      <div class="row fontawesome-icon-list">
        <div class="fa-icon-item">
